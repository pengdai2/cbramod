...
if __name__ == "__main__":
    ...
    parser.add_argument("--sliced-dir", type=str, required=True, help="Directory containing sliced .npy and _meta.json files")
    parser.add_argument("--labels-csv", type=str, default=None, help="Path to clinical labels CSV")
    parser.add_argument("--output-dir", type=str, required=True, help="Output directory for CSV manifests")
    parser.add_argument("--label-map", type=str, default=None, help="JSON string or path to JSON file for string-to-int mapping")
    parser.add_argument("--subject-id-col", type=str, default="subject_id", help="Column name for subject ID in labels CSV")
    parser.add_argument("--label-col", type=str, default="label", help="Column name for raw label in labels CSV")
    parser.add_argument("--train-ratio", type=float, default=0.70, help="Train set ratio")
    parser.add_argument("--val-ratio", type=float, default=0.15, help="Validation set ratio")
    parser.add_argument("--max-rejection-rate", type=float, default=0.15, help="Max allowable overall window rejection ratio (default: 0.15)")
    parser.add_argument("--max-n3-rejection-rate", type=float, default=0.10, help="Max allowable N3 stage rejection ratio (default: 0.10)")
    parser.add_argument("--min-valid-hours", type=float, default=4.5, help="Minimum usable sleep duration in hours (default: 4.5)")
